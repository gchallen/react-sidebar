...
var Sidebar = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    var sidebarStyle = _objectSpread(_objectSpread({}, defaultStyles.sidebar), this.props.styles.sidebar);
    var contentStyle = _objectSpread(_objectSpread({}, defaultStyles.content), this.props.styles.content);
    var overlayStyle = _objectSpread(_objectSpread({}, defaultStyles.overlay), this.props.styles.overlay);
    var useTouch = this.state.dragSupported && this.props.touch;
    var isTouching = this.isTouching();
    var rootProps = {
      className: this.props.rootClassName,
      style: _objectSpread(_objectSpread({}, defaultStyles.root), this.props.styles.root),
      role: "navigation",
    ...
    if (useTouch) {
      if (this.props.open) {
        ...
        var dragHandleStyle = _objectSpread(_objectSpread({}, defaultStyles.dragHandle), this.props.styles.dragHandle);
    ...
    return /*#__PURE__*/React.createElement("div", rootProps, /*#__PURE__*/React.createElement("div", {
